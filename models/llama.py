...
class Llama(nn.Module):
    ...
    def forward(self, prompts: List[str]):
        ...
        for p in prompts["prompt"]:
            ...
            outputs = self.model.generate(input_prompt.input_ids.to(self.device), num_beams = 3, max_new_tokens = 100, attention_mask=input_prompt.attention_mask.to(self.device), pad_token_id = self.tokenizer.eos_token_id)
