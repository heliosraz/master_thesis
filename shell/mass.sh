...
sbatch --job-name=mistral_1 --output=./shell/output/mistral_1_output.txt shell/deepseek.sh 1
...
sbatch --job-name=mistral_1 --output=./shell/output/deepseek_2_output.txt shell/deepseek.sh 2
...
sbatch --job-name=mistral_1 --output=./shell/output/deepseek_3_output.txt shell/deepseek.sh 3
...
sbatch --job-name=mistral_1 --output=./shell/output/deepseek_4_output.txt shell/deepseek.sh 4